...
Pausen werden im klassischen Notensatz nicht (wie bei Noten) mit Punkten geschrieben. Deswegen und aus Gründen der besseren Lesbarkeit vermeiden wir nach Möglichkeit punktierte Pausen.

In Dreiertakten (6/8-Takt, 3/4-Takt) beispielsweise sind punktierte Pausen aber in Ordnung, da sie die Lesbarkeit erhöhen.

> Beispiele keine punktierte Pausen:
>
> ``` lilypond
> \relative c' {
>   \time 4/4
...
![](/images/punktierte-pausen.svg)

> Beispiele punktierte Pausen:
>
> ``` lilypond
> \language "deutsch"
> \relative c' {
...
>   r4. r4. |
>   r4. r8 c d |
>   c8 d e r8 r16 c c8 % Das gilt natürlich nur, wenn es der Lesbarkeit explizit dient...
>
>   \time 3/4
>   r2. |
>   r2. |
...
![](/images/punktierte-pausen-2.svg)

## Rhythmusorientierte Taktaufteilung

Die Betonung des Taktes sollte (je nach Taktart) immer erkennbar sein.
